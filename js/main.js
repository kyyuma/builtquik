...
formSignup.find('input[type="submit"]').on('click', function(event){
	if(document.getElementById('signup-firstname').value){
		$('#signup-firstname').removeClass('has-error');
	}
	else{
		event.preventDefault();
		$('#signup-alert').show();
		$('#signup-firstname').addClass('has-error');
	}
});
formSignup.find('input[type="submit"]').on('click', function(event){
	if(document.getElementById('signup-lastname').value){
		$('#signup-lastname').removeClass('has-error');
	}
	else{
		event.preventDefault();
		$('#signup-alert').show();
		$('#signup-lastname').addClass('has-error');
	}
});
formSignup.find('input[type="submit"]').on('click', function(event){
	if(document.getElementById('signup-address').value){
		$('#signup-address').removeClass('has-error');
	}
	else{
		event.preventDefault();
		$('#signup-alert').show();
		$('#signup-address').addClass('has-error');
	}
});
formSignup.find('input[type="submit"]').on('click', function(event){
	if(document.getElementById('signup-phone').value){
...
formSignup.find('input[type="submit"]').on('click', function(event){
	if(document.getElementById('signup-dob').value){
		$('#signup-dob').removeClass('has-error');
	}
	else{
		event.preventDefault();
		$('#signup-alert').show();
		$('#signup-dob').addClass('has-error');
	}
});
formSignup.find('input[type="submit"]').on('click', function(event){
