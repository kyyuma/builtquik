...
function NewUser($con)
{
	...
	$query = "INSERT INTO customer (FirstName,LastName,Region,PhoneNumber,email,password,hash) VALUES
	('$firstName','$lastName','$region','$phone','$email','$password','$hash')";
	if($con->query($query) === TRUE)
	{
		$query = mysqli_query($con,"SELECT * FROM customer WHERE email = '$_POST[semail]' ") /*AND active = '1'"*/ or die(mysql_error());
