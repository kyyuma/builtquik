             ...
             <form name="sentMessage" id="workshopForm" novalidate="novalidate" method="POST" action="workshopadd.php"> <!--action="workshopadd.php"-->
              <div class="control-group">
                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                  <label>Address</label>
                  <input class="form-control" id="address" type="text" placeholder="Address"  name="swaddress" required="required" data-validation-required-message="Please enter your address.">
              ...
              <div class="control-group">
                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                  ...
                  <input class="form-control" id="contact" type="text" placeholder="Office Contact"  name="scontact" required="required" data-validation-required-message="Please enter your contact.">
                  <p class="help-block text-danger"></p>
                </div>
              </div>
              <div class="control-group">
                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                  <label>Email</label>
                  <input class="form-control" id="email" type="text" placeholder="Contact Email"  name="semail" required="required" data-validation-required-message="Please enter your email.">
                  <p class="help-block text-danger"></p>
                </div>
              </div>
              <div class="control-group">
              ...
              <div class="control-group">
                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                 ...
                 <div class="control-group">
                     <div id="workshopupdate" class="form-group floating-label-form-group controls mb-0 pb-2">
                    <button type="button" id="addnew" name="addnew" class="btn btn-primary btn-xl">Add Another</button>
                     </div>
                     </div>
              <div class="control-group">
                <div id="workshopupdate" class="form-group floating-label-form-group controls mb-0 pb-2">
