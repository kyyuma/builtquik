...
define('DB_NAME', 'liftingpoint');
define('DB_USER','root'); //defines database information, passwords, database name, needs different definations depending on database setup
define('DB_PASSWORD','');
